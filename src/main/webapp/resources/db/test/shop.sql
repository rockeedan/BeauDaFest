...
values (shopInfo_seq.nextval,'juwon','주원샵','02-1111-1111','서울시|서초구|서초동|12번지','10:00','18:00','2019/10/14/2019846505481.png','3샵정보',1,'취소정책');

insert into shopInfo(shopNum, memberId, shopName, shopPhone, shopAddr, shopOpen, shopOff, shopPhoto, shopIntro, shopParking, shopPolicy)
values (shopInfo_seq.nextval,'yoosin','유신샵','02-3333-3333','서울시|강남구|강남동|11번지','10:00','18:00','2019/10/14/cute.jpg','3샵정보',1,'취소정책');

insert into shopInfo(shopNum, memberId, shopName, shopPhone, shopAddr, shopOpen, shopOff, shopPhoto, shopIntro, shopParking, shopPolicy)
values (shopInfo_seq.nextval,'gamchan','감찬샵','02-2222-2222','서울시|마포구|마포동|13번지','10:00','18:00','2019/10/14/2019846722751.jpg','샵정보',0,'취소정책');
